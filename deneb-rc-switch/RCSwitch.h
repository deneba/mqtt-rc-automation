...
class RCSwitch {
  ...
  public:
    ...
    void send(char* Code);
    void sendEasyHome(unsigned long Code, unsigned int length);
    void sendRFWirelessDimmer(unsigned long Code, unsigned int length);
  ...
  private:
    ...
    void transmitHigh(int nHighPulses);
    void sendeasyhomelongsync();
